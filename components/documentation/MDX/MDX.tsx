...
const components = {
  ...
  h2: ({ className, ...props }) => (
    <h2
      className={cn(
        "pb-1 mt-10 text-3xl font-semibold tracking-tight border-b scroll-m-20 border-b-slate-200 first:mt-0",
        className
      )}
      {...props}
    />
  ...
  a: ({ className, ...props }) => (
    <a
      className={cn(
        "font-medium underline text-slate-900 underline-offset-4",
        className
      )}
      {...props}
    />
  ...
  img: ({
    ...
    <img
      className={cn("border rounded-md border-slate-200", className)}
      alt={alt}
      {...props}
    />
  ),
  ...
  tr: ({ className, ...props }: React.HTMLAttributes<HTMLTableRowElement>) => (
    <tr
      className={cn(
        "p-0 m-0 border-t border-slate-300 even:bg-slate-100",
        className
      )}
      {...props}
    />
  ...
  pre: ({ className, ...props }) => (
    <pre
      className={cn(
        "py-4 mt-6 mb-4 overflow-x-auto rounded-lg bg-slate-900",
        className
      )}
      {...props}
    />
